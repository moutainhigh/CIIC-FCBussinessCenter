...
public class KafkaReceiver {
    ...
    public void salaryGrantPaymentProcess(Message<PayApplyPayStatusDTO> message) {
        try {
            ...
            if (!ObjectUtils.isEmpty(dto) && dto.getPayApplySalaryDTOList().size()>0 && SalaryGrantBizConsts.SETTLEMENT_CENTER_BUSINESS_TYPE_SG.equals(dto.getBusinessType()) && SalaryGrantBizConsts.SETTLEMENT_CENTER_PAY_STATUS_SUCCESS.equals(dto.getPayStatus())) {
