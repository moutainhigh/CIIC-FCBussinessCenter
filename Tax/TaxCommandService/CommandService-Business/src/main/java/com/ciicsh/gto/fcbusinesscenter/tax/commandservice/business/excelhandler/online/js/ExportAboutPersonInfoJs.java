 ...
 */
@Service
public class ExportAboutPersonInfoJs extends BaseService {
    /**
     * 导出人员信息excel
     *
        ...
        try {
            ...
            if (wb != null) {
                try {
                    ...
                    //日志工具类返回
                    LogTaskFactory.getLogger().error(ee, "ExportAboutPersonInfoJs.getPersonInfoWB", EnumUtil.getMessage(EnumUtil.SOURCE_TYPE, "06"), LogType.OTHER, tags);
                }
            }
            throw e;
        }
