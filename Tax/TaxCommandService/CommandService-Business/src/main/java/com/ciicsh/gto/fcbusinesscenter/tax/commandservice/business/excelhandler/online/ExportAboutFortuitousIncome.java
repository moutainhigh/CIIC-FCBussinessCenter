 ...
 */
@Service
public class ExportAboutFortuitousIncome extends BaseService {
    /**
     * 导出偶然所得
     *
        ...
        try {
            ...
            if (wb != null) {
                try {
                    ...
                    //日志工具类返回
                    LogTaskFactory.getLogger().error(ee, "ExportAboutFortuitousIncome.getFortuitousIncomeWB", EnumUtil.getMessage(EnumUtil.SOURCE_TYPE, "06"), LogType.OTHER, tags);
                }
            }
            throw e;
        }
