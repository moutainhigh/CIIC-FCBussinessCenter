...
//        taskSubDeclareDetailPOList = baseMapper.selectList(wrapper);
        ...
        for (Map.Entry<String, List<TaskSubDeclareDetailPO>> entry : groupbys.entrySet()) {
            ...
            if ((entry.getKey().endsWith(IncomeSubject.NORMALSALARY.getCode()) || entry.getKey().endsWith(IncomeSubject.FOREIGNNORMALSALARY.getCode()))
                ...
                taskSubDeclareDetailPO.setDeductOther(otherDeductions);
                ...
                taskSubDeclareDetailPO.setIncomeForTax(taskSubDeclareDetailPO.getIncomeTotal()
                        .subtract(taskSubDeclareDetailPO.getIncomeDutyfree())
                        .subtract(taskSubDeclareDetailPO.getDeductTotal())
                        .subtract(taskSubDeclareDetailPO.getDeduction())
                        .subtract(taskSubDeclareDetailPO.getDonation()));
                //应纳税额 = 税金
