 ...
 */
@Service
public class ExportAboutIDDIncome extends BaseService {
    /**
     * 导出利息、股息、红利所得
     *
        ...
        try {
            ...
            if (wb != null) {
                try {
                    ...
                    //日志工具类返回
                    LogTaskFactory.getLogger().error(ee, "ExportAboutIDDIncome.getIDDIncomeWB", EnumUtil.getMessage(EnumUtil.SOURCE_TYPE, "06"), LogType.OTHER, tags);
                }
            }
            throw e;
        }
