package com.ciicsh.gto.fcbusinesscenter.util.poi;

import com.ciicsh.gto.fcbusinesscenter.util.poi.exception.CellGetOrSetException;
import com.ciicsh.gto.fcbusinesscenter.util.poi.exception.CellRuleException;
import com.ciicsh.gto.fcbusinesscenter.util.poi.exception.XSSFCellTypeException;
import com.ciicsh.gto.fcbusinesscenter.util.poi.model.*;
import com.ciicsh.gto.fcbusinesscenter.util.poi.utils.BeanUtils;
import com.ciicsh.gto.fcbusinesscenter.util.poi.utils.CellDataConverter;
import com.ciicsh.gto.fcbusinesscenter.util.poi.utils.DigestUtils;
import com.ciicsh.gto.fcbusinesscenter.util.poi.utils.FieldUtils;
    ...
    private CellStyle createCellStyle(Workbook workbook, CellSettings cellSettings, boolean isTitle){
        ...
        try {
            if (!isTitle) {
                ...
                if (cellSettings.getCellStyleSettings() != null && cellSettings.getCellStyleSettings().getCellDataType() != null){
                    switch (cellSettings.getCellStyleSettings().getCellDataType()){
                        case VARCHAR:
