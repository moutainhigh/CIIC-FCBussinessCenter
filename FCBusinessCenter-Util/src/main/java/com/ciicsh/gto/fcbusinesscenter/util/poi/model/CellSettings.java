package com.ciicsh.gto.fcbusinesscenter.util.poi.model;
...
public final class CellSettings {
	...
	public CellSettings setCellStyleSettings(CellStyleSettings cellStyleSettings) {
		this.cellStyleSettings = cellStyleSettings;
		return this;
	}
	...
	public String toString() {
		return "CellSettings{" +
				...
				", isSelect=" + isSelect +
				", cellSelectSettings=" + cellSelectSettings +
				", subCells=" + subCells +
				", cellDataType=" + cellDataType +
				", cellStyleSettings=" + cellStyleSettings +
				", cellClass=" + cellClass +
				", formulaGroupNames=" + Arrays.toString(formulaGroupNames) +
				", pattern=" + pattern +
				", skip=" + skip +
				", cellSeq=" + cellSeq +
				'}';
