package com.ciicsh.gt1.fcbusinesscenter.compute.config;
...
public class DruidConfig {
    ...
    private String dbConfigPathBusiness;

    @Primary
    @Bean(name = "dbConfigPathBusiness")
    public DataSource dataSourceBusiness() throws SQLException {
        DruidDataSource datasource = new DruidDataSource();
        Properties prop = this.readProperties(dbConfigPathBusiness);
